...
function convertToDisplay(timeNow) {
  ...
  var monthSecsRemaining = Math.floor(yearSecsRemaining % (26 * 28 * 60 * 60)) +
    1;
...
function backgroundImageChanger(month, day, hour, minute) {
  ...
  var starryNightImgUrl =
    '../img/1409058910637_wps_9_PIC_BY_MATT_PAYNE_CATERS_[1].jpg';
  var stormyDayImgUrl =
    '..img/pct-section-k-83-granite-chief-wilderness[1].jpg';
  if (hour >= 22 || hour < 4) {
    pmFlag = true;
...
function update(currentTime) {
  backgroundImageChanger(currentTime.months, currentTime.days, currentTime.hours,
    currentTime.minutes);
